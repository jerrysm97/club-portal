...
export default function IIMSAffiliationStrip() {
    return (
        <div className="bg-[#1A237E] text-white py-2 px-4 flex items-center justify-center text-xs font-medium z-50 relative">
            <span className="opacity-90 mr-2 hidden sm:inline">The official IT Club of</span>
