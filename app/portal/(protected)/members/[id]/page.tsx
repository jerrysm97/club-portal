...
export default async function MemberViewPage(props: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-10 pb-16 animate-fade-up">
            <Link href="/portal/dashboard" className="inline-flex items-center gap-2 text-[#757575] hover:text-[#111111] font-bold text-xs uppercase tracking-widest transition-all group">
                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-[2rem] p-8 md:p-10 border border-[#E0E0E0] shadow-sm space-y-10">
                        ...
                        <div className="pt-8 border-t border-[#E0E0E0]">
                            <Link href={`/portal/messages/${member.id}`} className="bg-[#111111] rounded-sm p-5 flex items-center justify-between group cursor-pointer hover:bg-[#C8102E] transition-all shadow-sm shadow-[#111111]/20">
